...
from kb_motupan.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_motupan'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_motupan.kb_motupanImpl import kb_motupan  # noqa @IgnorePep8
impl_kb_motupan = kb_motupan(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_motupan'
